...
$(document).ready(function() {
  $('#age-calc').submit(function(event) {
    ...
    let mercuryRemainingYrs = userAge.getMercuryRemaininYrs();
    let venusRemainingYrs = userAge.getVenusRemaininYrs();
    let marsRemainingYrs = userAge.getMarsRemaininYrs();
    let jupiterRemainingYrs = userAge.getJupiterRemaininYrs();
